...
def app():
    # Custom CSS with enhanced animations and neo gradient effects
    def load_css():
        return """
        <style>
    ...
    # Header Section with centered title and right-aligned wallet button
    st.markdown("""
    ...
    features = [
        ...
        {"icon": "fas fa-globe", "title": "Web3 Integration", "desc": "Earn tokens, Learn tokens, mint NFTs, and trade in the marketplace."}
    ]
